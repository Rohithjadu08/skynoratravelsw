...
exports.TRAVEL_TOOLS = void 0;
exports.getGeminiTools = getGeminiTools;
exports.TRAVEL_TOOLS = [
    {
        name: "search_flights",
...
function mapType(t) {
    switch (t) {
        ...
        default: return genai_1.Type.STRING;
    }
}
function transformProperties(props) {
    ...
    for (const [key, val] of Object.entries(props)) {
        ...
        if (val.enum)
            propCopy.enum = val.enum;
        if (val.items)
            propCopy.items = { type: mapType(val.items.type) };
        result[key] = propCopy;
    }
    return result;
}
function getGeminiTools() {
    return exports.TRAVEL_TOOLS.map((t) => ({
        name: t.name,
        description: t.description,
        parameters: {
            type: genai_1.Type.OBJECT,
            properties: transformProperties(t.input_schema.properties),
