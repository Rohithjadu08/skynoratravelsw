...
exports.MockPlacesProvider = void 0;
...
class MockPlacesProvider {
    ...
    async searchRestaurants(input) {
        ...
        if (input.dietary && input.dietary.length > 0) {
            restaurants = restaurants.filter((r) => input.dietary.some((d) => r.dietaryOptions.some((opt) => opt.toLowerCase().includes(d.toLowerCase()))));
        }
...
exports.MockPlacesProvider = MockPlacesProvider;
//# sourceMappingURL=places.mock.js.map